 ...
 *
 */
class tx_paypal2commerce_payment_paypal_express extends tx_commerce_payment_abstract {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']["ext/paypal2commerce/classes/class.tx_paypal2commerce_payment_paypal_express.php"])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']["ext/paypal2commerce/classes/class.tx_paypal2commerce_payment_paypal_express.php"]);
}
?>
